  ...
  const slides = [
    {
      ...
      primaryButtonAction: 'app-downloads' as const, // Goes to app downloads
    ...
    },
    {
      ...
      primaryButtonAction: 'receiver-signup' as const, // Goes to receiver signup
      secondaryButton: "Watch How It Works"
    }
  ];
    ...
    <section className="bg-white py-20 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 pt-2">
                      <button 
                        ...
                        className="bg-red-500 text-white px-8 py-3 rounded-lg font-semibold hover:bg-red-600 transition-colors shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200"
                      >
                        {slide.primaryButton}
                      </button>
                    ...
                    <div className="flex justify-center space-x-4">
                      <div className="relative">
                        <img 
                          ...
                          className="w-64 h-auto rounded-3xl shadow-2xl transform hover:scale-105 transition-transform duration-300" 
                        />
          ...
          <button
            onClick={prevSlide}
            className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-white/80 backdrop-blur-sm hover:bg-white text-gray-700 p-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-200 z-10"
          >
            <ChevronLeft className="w-6 h-6" />
          </button>
          <button
            onClick={nextSlide}
            className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-white/80 backdrop-blur-sm hover:bg-white text-gray-700 p-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-200 z-10"
          >
